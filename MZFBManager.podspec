...
Pod::Spec.new do |s|
  s.name             = 'MZFBManager'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MZFBManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chensh/MZFBManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chensh' => 'mail2chensh@gmail.com' }
  s.source           = { :git => 'https://github.com/chensh/MZFBManager.git', :tag => s.version.to_s }
